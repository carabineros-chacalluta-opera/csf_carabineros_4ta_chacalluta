// ============================================================
// SISTEMA CSF OPERATIVA — config.js  v3.0
// Prefectura Arica No. 1 - Carabineros de Chile
// CORRECCIONES v1.4.1:
//   FIX-C02 — Agregado VALIDADOR en CSF_CONFIG.ROLES
//   FIX-Q09 — Agregada constante UF_FALLBACK (antes hardcodeado en core.js)
// CAMBIOS v3.0:
//   Ajuste version para reflejar migración AUTH-01 (sin Supabase Auth)
// ============================================================
...
const CSF_CONFIG = {
  ...
  // FIX-C02: agregado VALIDADOR (antes ausente, causaba comparaciones hardcoded en 8+ funciones)
  ROLES: {
    COMISARIO:     'comisario',
  ...
  // FIX-Q09: valor de respaldo UF cuando la API de mindicador.cl falla
  UF_FALLBACK: 37000,
