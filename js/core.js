// ============================================================
// SISTEMA CSF OPERATIVA — core.js  v1.4.1
...
//              ELIMINAR el bloque duplicado en index.html lineas 145-148.
//   FIX-Q09 — obtenerValorUF() usa CSF_CONFIG.UF_FALLBACK en lugar de 37000 hardcoded
...
async function iniciarApp() {
  ...
  // FIX-C03: onAuthStateChange registrado UNA sola vez, aqui.
  // El bloque duplicado en index.html (aprox. lineas 145-148) debe ser ELIMINADO.
...
// cerrarSesion() — version completa y canonica (FIX-C01: la de login.js fue eliminada)
