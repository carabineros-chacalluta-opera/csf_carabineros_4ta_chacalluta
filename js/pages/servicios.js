// ============================================================
// SISTEMA CSF OPERATIVA — servicios.js  v2.0
// CAMBIOS v2.0:
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:.75rem">
        <div class="campo-inline">
          ...
          <input id="codigo-resp" type="text" placeholder="Ej: 42891" maxlength="10"
                 value="${svc.codigo_jefe_servicio||''}" style="width:140px" onblur="validarCodigo(this.value)"/>
        ...
        <div class="campo-inline">
          ...
          <input id="folio-libro" type="text" placeholder="Ej: 00124" maxlength="20"
                 value="${svc.folio_libro_fisico||''}" style="width:120px;font-family:monospace;font-weight:700"/>
        </div>
      </div>
    </div>
